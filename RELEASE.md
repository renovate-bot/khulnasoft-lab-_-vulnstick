...
Vulnstick is published as a git tag in the repo, not to PyPI or elsewhere.

## Creating a new release

You can release Vulnstick by running `make release` (if you have the appropriate repo permissions).

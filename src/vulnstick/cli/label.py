...
import vulnstick
from vulnstick import artifact, label, store
from vulnstick.cli import config, display, explore
...
def compare_results_against_labels(  # noqa: PLR0913
    ...
    ) = vulnstick.compare_results_against_labels(
...
def compare_results_against_labels_by_ecosystem(
    ...
    results_by_image, _, stats = vulnstick.compare_results_against_labels_by_ecosystem(
        result_set=result_set,
        year_max_limit=year_max_limit,
        year_from_cve_only=derive_year_from_cve_only,
    )
